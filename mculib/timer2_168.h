...
#define GDT_TCCRnA   GADGET1
#define GDT_TCNTn    GADGET2
#define GDT_TCCRnB   GADGET3
#define GDT_OCRnA    GADGET4
#define GDT_OCRnB    GADGET5
#define GDT_ASSR     GADGET6

#define GDT_CLOCK    GADGET7
#define GDT_MODE     GADGET8
#define GDT_BUFA     GADGET9
#define GDT_BUFB     GADGET10
